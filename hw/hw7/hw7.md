...
### Response
I don't really understand this question. From my knowledge, and my understanding this is already complete. It might just be because I wrote the tasks into their own methods, but The code I have written up to now i.e. upperTriangleInit, lowerTriangleInit, diagInit, Ainit, are all easily modifiable for tasks to initialize a matrix to just a square (see [Ainit](https://github.com/nicoleefleming/math4610/blob/master/softwareManual/Pages/Ainit.md)), an upper Triangle (see [upperTriangleInit](https://github.com/nicoleefleming/math4610/blob/master/softwareManual/Pages/upperTriangleInit.md)), lower triangle (see [lowerTriangleInit](https://github.com/nicoleefleming/math4610/blob/master/softwareManual/Pages/lowerTriangleInit.md)), and a diagonal matrix (see [diagInit](https://github.com/nicoleefleming/math4610/blob/master/softwareManual/Pages/diagInit.md)). All of these methods take the input of an integer n to initialize the matrix. The only part that would change is the values being assigned if there is a specific formula. 
